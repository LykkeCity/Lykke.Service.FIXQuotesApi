...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./client/Lykke.Service.FIXQuotesApi.Client/AutorestClient -Namespace Lykke.Service.FIXQuotesApi.Client.AutorestClient